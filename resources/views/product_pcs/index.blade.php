...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Product Pcs'])
    <div class="row mt-1 px-1">
        <div class="card">
            <div class="card-header px-1">
                <a href="javascript:void(0)" class="btn btn-primary btn-md mb-2 float-left pcs-add">Tambah
                    Product Pcs</a>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="titleModal">Form Product Pcs</h5>
                </div>
                <form class="save-form">
                    <input type="hidden" name="url_link" value="{{ route('pcs.store') }}">
...
@section('script')
    ...
    <script>
        ...
        function addForm() {
            $(".pcs-add").click(function(e) {
                e.preventDefault();
                $('.my-modal').modal('show');
                $('.save-form')[0].reset();
                $("input[name=edit_id]").val("");
                $("#titleModal").html(`Form Tambah Product Pcs`);
            });
        }
        ...
        function editForm() {
            $(document).on("click", ".pcs-edit", function(e) {
                e.preventDefault();
                let editId = $(this).data('id');
                $('.my-modal').modal('show');
                $("#titleModal").html(`Form Edit Product Pcs`);
                $('.save-form')[0].reset();
        ...
        function deleteForm() {
            $(document).on("click", ".pcs-delete", function(e) {
                e.preventDefault();
